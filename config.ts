...
//      You must add the URL where your app is running.
...
const getRedirectUri = () => {
  ...
  // We force a trailing slash to handle both 'localhost:3000' and 'github.io/repo/' correctly.
...
export const CONFIG = {
  spotify: {
    ...
    redirectUri: getRedirectUri('https://jimmyu2foru18.github.io/Music-Website/'), 
  },
  youtube: {
